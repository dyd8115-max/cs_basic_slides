  ...
  <div class="screen intro-type" id="s2">
    <div class="toc-screen">
      ...
      <div class="toc-card-grid">
        <div class="toc-card toc-c1" onclick="go(1)">
          <div class="toc-card-num">01</div>
          <div class="toc-card-body">
            <div class="toc-card-title">AI 기초 개념</div>
            <div class="toc-card-desc">AI · ML · DL · LLM 기초 용어 정리</div>
          </div>
        ...
        <div class="toc-card toc-c3" onclick="go(4)">
          <div class="toc-card-num">04</div>
          <div class="toc-card-body">
            <div class="toc-card-title">AI 번역 기술</div>
            <div class="toc-card-desc">문맥 이해 · Transformer 기반 · 서비스 사례</div>
          </div>
          <div class="toc-card-tag">2 slides</div>
        </div>
        <div class="toc-card toc-c4" onclick="go(5)">
          ...
          <div class="toc-card-body">
            <div class="toc-card-title">AI 음악 기술</div>
            <div class="toc-card-desc">프롬프트→음악 생성 · 활용 사례 · 미래</div>
          </div>
          <div class="toc-card-tag">2 slides</div>
        </div>
        <div class="toc-card toc-c1" onclick="go(6)">
        ...
        <div class="toc-card toc-c4" onclick="go(7)">
        ...
        <div class="toc-card toc-c5" onclick="go(8)">
        ...
        <div class="toc-card toc-c6" onclick="go(9)">
          <div class="toc-card-num">09</div>
          <div class="toc-card-body">
        ...
        <div class="toc-card toc-c1" onclick="go(10)">
          <div class="toc-card-num">10</div>
          <div class="toc-card-body">
        ...
        <div class="toc-card toc-c2 toc-last" onclick="go(11)">
          <div class="toc-card-num">11</div>
          <div class="toc-card-body">
